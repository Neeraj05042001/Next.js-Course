          ...
          {tasks.map((task) => (
            ...
            >
              ...
              <div className="flex space-x-4">
                ...
                <button
                  className="edit-btn px-4 py-2 text-white bg-blue-600
                ...
                {task.status !== "Completed" && (
                  <button
                    className=" complete-btn px-4 py-2 text-white bg-green-600
                ...
                <button
                  className=" delete-btn px-4 py-2 text-gray-700 bg-gray-100
